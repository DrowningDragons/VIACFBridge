...
void UVIACFRiderAnimInstance::NativeInitializeAnimation()
{
...
void UVIACFRiderAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
...
void UVIACFRiderAnimInstance::OnStartVault()
{
	K2_OnStartVault();
}

void UVIACFRiderAnimInstance::OnStopVault()
{
	// Stopped vaulting
	bRHand = false;
	bLHand = false;
...
void UVIACFRiderAnimInstance::SetBoneFBIK_Implementation(const FName& BoneName, const FVector& BoneLocation, bool bEnabled)
{
