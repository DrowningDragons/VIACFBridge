...
#include "VITypes.h"
#include "VIACFRiderAnimInstance.generated.h"
 ...
 */
UCLASS()
class VIACFBRIDGE_API UVIACFRiderAnimInstance : public UACFRiderAnimInstance, public IVIAnimationInterface
{
	GENERATED_BODY()
